...
feature_extractors="iBOTViTBaseBCa"

save_dir="/mnt/hd0/project/BCaCAD/model/slide_features"
...
do
    ...
    do
        ...
        PYTHONPATH=. HYDRA_FULL_ERROR=1 python -m debugpy --listen 5678 --wait-for-client ./tools/extract_features/extract_slide_features.py \
            ...
            num_workers=16 \
            device="[0,1]" \
            features_output_dir=$save_dir/$dataset
        wait
    done
done
