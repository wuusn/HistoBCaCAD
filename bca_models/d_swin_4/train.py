...
def main(args):
    ...
    ssl_model = ibot_base_pancancer = iBOTViT(architecture="vit_base_pancan", encoder="student", weights_path=weights_path).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight-save-path', type=str,
                        default="/mnt/hd0/project_large_files/bca_grading/suqh/ssl_swin/weights")

    parser.add_argument('--log-save-path', type=str,
                        default="/mnt/hd0/project_large_files/bca_grading/suqh/ssl_swin/logs")
