...
class Chowder(nn.Module):
    ...
    def __init__(
        ...
        self.mlp1.apply(self.weight_initialization)
        self.mlp2 = MLP(
            mlp_in_features,
            1,
            hidden=mlp_hidden,
        ...
        self.mlp2.apply(self.weight_initialization)
    ...
    def forward(
        ...
        y1 = self.mlp1(extreme_scores.transpose(1, 2))  # (B, OUT_FEATURES, 1)
        y2 = self.mlp2(extreme_scores.transpose(1, 2))
        return y1.squeeze(2), y2.squeeze(2)
