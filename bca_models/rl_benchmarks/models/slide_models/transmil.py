...
class TransMIL(Module):
    ...
    def __build(self):
        ...
        self.head1 = nn.Linear(inner_dim, self.out_features[0], bias=True)
        self.head2 = nn.Linear(inner_dim, self.out_features[1], bias=True)
    ...
    def forward(
        ...
        logits = self.head1(xx), self.head2(xx)
