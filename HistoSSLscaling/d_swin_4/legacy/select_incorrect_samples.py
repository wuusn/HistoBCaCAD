...
def main(args):
    ...
    assert os.path.exists(args.weights), "weights_tif file: '{}' not exist.".format(args.weights)
...
if __name__ == '__main__':
    ...
    # 训练权重路径
    parser.add_argument('--weights_tif', type=str, default='./weights_tif/model-19.pth',
                        help='initial weights_tif path')
    # 是否冻结权重
