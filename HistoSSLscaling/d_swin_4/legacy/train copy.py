...
def main(args):
    ...
    train_images_path, train_images_label, train_images_ncl, train_images_epi, train_images_tub, train_images_mit, \
    val_images_path, val_images_label, val_images_ncl, val_images_epi, val_images_tub, val_images_mit = \
        read_split_data(args.data_path, args.ncl_path, args.epi_path, args.tub_path, args.mit_path)
    ...
    train_dataset = MyDataSet(images_path=train_images_path,
                              ...
                              images_ncl=train_images_ncl,
                              images_epi=train_images_epi,
                              images_tub=train_images_tub,
                              images_mit=train_images_mit,
                              transform=data_transform["train"])

    # 实例化验证数据集
    val_dataset = MyDataSet(images_path=val_images_path,
                            images_class=val_images_label,
                            images_ncl=val_images_ncl,
                            images_epi=val_images_epi,
                            images_tub=val_images_tub,
                            images_mit=val_images_mit,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="/mnt/disk1/bjy/dataset/Biox/train_val/")
    ...
    parser.add_argument('--weights', type=str, default='/mnt/disk1/bjy/pyproject/pre_module/pytorch_classification/swin_tiny_patch4_window7_224.pth',
