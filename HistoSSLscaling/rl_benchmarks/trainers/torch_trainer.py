...
class TorchTrainer(BaseTrainer):
    ...
    def train(
        ...
        for epoch in loop:
            ...
            # Inference step.
            # val_epoch_loss, val_epoch_logits, val_epoch_preds, val_epoch_labels = self.val_step(
            #     model=model,
            ...
            val_epoch_logits = train_epoch_logits
            val_epoch_preds = train_epoch_preds
            val_epoch_labels = train_epoch_labels
        ...
        return {'train': (train_epoch_labels, train_epoch_logits, train_epoch_preds),
                'test': (val_epoch_labels, val_epoch_logits, val_epoch_preds)}
    ...
    def predict(
        ...
        _, test_epoch_logits, test_epoch_preds, test_epoch_labels = self.val_step(
                model=model,
                val_dataloader=test_dataloader,
                criterion=criterion,
                device=self.device,
        ...
        return test_epoch_labels, test_epoch_logits, test_epoch_preds
