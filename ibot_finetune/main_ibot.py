...
def get_args_parser():
    ...
    parser.add_argument('--pred_ratio', default=[0,0.3], type=float, nargs='+', help="""Ratio of partial prediction.
        If a list of ratio is specified, one of them will be randomly choosed for each patch.""")
    parser.add_argument('--pred_ratio_var', default=[0,0.2], type=float, nargs='+', help="""Variance of partial prediction
    ...
    parser.add_argument('--teacher_patch_temp', default=0.07, type=float, help=""""See 
        `--teacher_temp`""")
    parser.add_argument('--warmup_teacher_temp_epochs', default=6, type=int,
    ...
    parser.add_argument('--min_lr', type=float, default=2e-7, help="""Target LR at the
        end of optimization. We use a cosine LR schedule with linear warmup.""")
    parser.add_argument('--optimizer', default='adamw', type=str,
        choices=['adamw', 'sgd', 'lars'], help="""Type of optimizer. We recommend using adamw with ViTs.""")
    # parser.add_argument('--load_from', default='/home/yuxin/breast_cad/ibot_vit_base_pancan.pth', help="""Path to load checkpoints to resume training.""")
    parser.add_argument('--load_from', default='/home/yuxin/ibot/output_swin_base/checkpoint.pth', help="""Path to load checkpoints to resume training.""")
    ...
    # Misc
    parser.add_argument('--data_path', default='/home/yuxin/breast_cad/SUQH_10x336/train', type=str,
        help='Please specify path to the ImageNet training data.')
    parser.add_argument('--output_dir', default="./output_swin_base", type=str, help='Path to save logs and checkpoints.')
    parser.add_argument('--saveckp_freq', default=10, type=int, help='Save checkpoint every x epochs.')
    parser.add_argument('--seed', default=95, type=int, help='Random seed.')
...
def train_ibot(args):
    ...
    copy_self(f'{args.output_dir}/main_ibot.py')
