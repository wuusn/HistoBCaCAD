...
save_root = pathlib.Path('/mnt/hd1/bcacad/frozen_pretrain_ft_truely_checked')
...
# print how much is frozen

def summarize_frozen(model: nn.Module):
...
# … after you build and .to(device) your model:
summarize_frozen(model)
...
optimizer = SAM(pg, base_optimizer,lr=1e-3, betas=(0.9, 0.999), weight_decay=0.05) # default -6
