...
weights_dir = pathlib.Path('/media/dc/T7 Shield/breast_cad/2023_12_15_18_17_54')
...
weight_path = '/media/dc/T7 Shield/breast_cad/2023_12_15_18_17_54/model-33.pth'
...
data_root = {
    'SUQH': pathlib.Path('/media/dc/T7 Shield/breast_cad/SUQH_10x336/test'),
    'QDUH': pathlib.Path('/media/dc/T7 Shield/breast_cad/qingdao_test/test'),
    'SHSU': pathlib.Path('/media/dc/T7 Shield/breast_cad/shandaer_test/test'),
    'BRACS': pathlib.Path('/media/dc/T7 Shield/breast_cad/bracs_patch/latest_version_patch'),
    'BACH': pathlib.Path('/media/dc/T7 Shield/breast_cad/bach_patch/Photos_patch_tif'),
}
