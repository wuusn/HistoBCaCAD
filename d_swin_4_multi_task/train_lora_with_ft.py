...
data_root = pathlib.Path('/mnt/hd0/project/bcacad/data/patch-level/suqh')
# data_root = pathlib.Path('/home/yuxin/ssd_data/SUQH_10x336')
phases = ['train', 'val', 'test']
save_root = pathlib.Path('/mnt/hd1/bcacad/timm_lora_ft')
...
data_root = {
    'SUQH': pathlib.Path('/mnt/hd0/project/bcacad/data/patch-level/suqh'),
    'QDUH': pathlib.Path('/mnt/hd0/project/bcacad/data/patch-level/qduh/test'),
    'SHSU': pathlib.Path('/mnt/hd0/project/bcacad/data/patch-level/shsu/test'),
}
...
optimizer = SAM(pg, base_optimizer,lr=5e-5, betas=(0.9, 0.999), weight_decay=0.05) # default -6
...
ckpt_path = '/mnt/hd1/bcacad/timm_lora/2025_07_10_21_19_13/model-16.pth'
#ckpt_path = '/mnt/hd1/bcacad/timm_lora/2025_07_09_23_27_52/model-5.pth'
#ckpt_path = '/mnt/hd1/bcacad/timm_lora/2025_07_09_10_18_49/model-7.pth'
