...
def wsi2Patch(path, save_dir, save_ext, max_mag, curr_mag, psize, ncpu):
    ...
    multiRunStarmapN(ncpu, wsi2OnePatch, path, max_mag, curr_mag, coords, psize, save_dir, save_ext)
